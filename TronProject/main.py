...
class Player:
    ...
    def choose_direction(self, old, new):
        if old.x < new.x:
            return "RIGHT"
        if old.y < new.y:
            return "UP"
    ...
    def Dijkstra(self, board, position, occupied):
    ...
    def turn_or_not(self, direction, aim):
    ...
    def change_aim(self, opponent_player):
        ...
        occupiedForAI = occupiedCopy.union({self.get_position()})
